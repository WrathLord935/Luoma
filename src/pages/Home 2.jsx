...
export default function Home() {
    ...
    // Animated values
    const statTextiles = useCountUp(5000);
    const statWater = useCountUp(2100000); // 2.1M
    const statLoopers = useCountUp(12400); // 12k

    // Format large numbers
    const formatNumber = (num) => {
        if (num >= 1000000) return (num / 1000000).toFixed(1) + 'M';
        if (num >= 1000) return (num / 1000).toFixed(0) + ',000'; // Specific formatting for design
            ...
            <div className="loop-live-banner">
                <div className="loop-track">
                    ...
                    <div className="loop-content">
                        <span><Zap size={16} className="icon-cinnamon" /> <b className="text-cinnamon">@alex</b> just swapped a North Face Jacket</span>
                        <span className="separator">●</span>
                        <span><Leaf size={16} className="icon-accent" /> <b className="text-accent">@sara</b> saved 500L of water</span>
                        <span className="separator">●</span>
                        <span><Flame size={16} className="icon-cinnamon" /> New Drop: <b className="text-cinnamon">Vintage Levis</b></span>
                        <span className="separator">●</span>
                        <span><Zap size={16} className="icon-accent" /> <b className="text-accent">@mike</b> listed 3 new items</span>
                        <span className="separator">●</span>
                        <span><RefreshCcw size={16} className="icon-cinnamon" /> <b className="text-cinnamon">124 items</b> diverted today</span>
                    </div>
            ...
            <section className="stats-section">
                ...
                <div className="stats-bento">
                    ...
                    <div className="stat-card stat-medium variant-water animate-pop-in" style={{ animationDelay: '0.2s' }}>
                        ...
                        <h3 className="stat-value">2.1M</h3>
